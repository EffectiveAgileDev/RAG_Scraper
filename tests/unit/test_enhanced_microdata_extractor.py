...
class TestEnhancedMicrodataExtractor:
    ...
    def test_extractor_with_extraction_context(self):
        ...
        from src.scraper.enhanced_microdata_extractor import MicrodataExtractor, ExtractionContext
    ...
    def test_deduplicate_with_child_precedence(self):
        ...
        from src.scraper.enhanced_microdata_extractor import MicrodataExtractor, ExtractionContext, DataCorrelator
    ...
    def test_extraction_timestamp_tracking(self):
        ...
        with patch('src.scraper.enhanced_microdata_extractor.datetime') as mock_datetime:
            mock_dt = Mock()
    ...
    def test_cross_page_entity_correlation(self):
        ...
        tracker.add_entity_mention("Italian Bistro", "dir_001", {
            'name': 'Italian Bistro',
            'description': 'Authentic cuisine'
        })
        
        # Add same restaurant from detail page
        tracker.add_entity_mention("Italian Bistro", "rest_001", {
            'name': 'Italian Bistro',
            'phone': '555-0123',
            'address': '123 Main St'
        })
