...
class TestRelationshipPersistence:
    ...
    def test_save_with_special_characters(self, tmp_path):
        ...
        tracker.track_relationship(rest1, rest2, "reference", {
            "note": "Special chars: café, björk, 中文"
        })
    ...
    def test_save_preserves_timestamps(self, tmp_path):
        ...
        assert data['relationship_index']['sibling'][0]['timestamp'] == "2024-01-15T10:30:00"
    ...
    def test_save_load_preserves_bidirectional_references(self, tmp_path):
        ...
        tracker.track_relationship(rest1, rest2, "reference")
        tracker.track_relationship(rest2, rest1, "reference")  # This creates bidirectional
        ...
        assert new_tracker.relationships[rest1]['reference_metadata'][rest2].get('bidirectional') is True
        assert new_tracker.relationships[rest2]['reference_metadata'][rest1].get('bidirectional') is True
