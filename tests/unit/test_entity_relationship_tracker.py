...
class TestEntityRelationshipTracker:
    ...
    def test_create_entity_with_auto_id(self):
        ...
        entity_id = tracker.create_entity(
            url="/restaurants/italian-bistro",
    ...
    def test_unique_id_generation(self):
        ...
        for i in range(10):
            entity_id = tracker.create_entity(
                url=f"/restaurants/restaurant-{i}",
                entity_type="restaurant"
            )
    ...
    def test_track_reference_relationship(self):
        ...
        assert tracker.relationships[rest_id]['reference_metadata'][loc_id]['ref_type'] == "location"
    ...
    def test_circular_reference_detection(self):
        ...
        assert tracker.relationships[rest1]['reference_metadata'][rest2].get('bidirectional') is True
        assert tracker.relationships[rest2]['reference_metadata'][rest1].get('bidirectional') is True
