...
class TestMultiPageScraperErrorHandling:
    ...
    def test_handle_network_failure(self):
        ...
        with patch.object(scraper, '_fetch_page') as mock_fetch:
            ...
            # Test error handling
            result = scraper._handle_page_error("http://example.com/", "ConnectionError", "Network unreachable")
    ...
    def test_handle_timeout_error(self):
        ...
        with patch.object(scraper, '_fetch_page') as mock_fetch:
            ...
            result = scraper._handle_page_error("http://example.com/slow", "TimeoutError", "Request timeout")
    ...
    def test_retry_failed_pages(self):
        ...
        with patch.object(scraper, '_fetch_page') as mock_fetch:
            ...
            mock_fetch.side_effect = [ConnectionError("Network error"), "<html>Success</html>"]
    ...
    def test_handle_missing_dependencies(self):
        ...
        with patch.object(scraper, '_fetch_and_process_page') as mock_process:
            ...
            result = scraper._handle_dependency_error("ImportError", "Missing beautifulsoup4")
    ...
    def test_error_aggregation_and_reporting(self):
        ...
        errors = [
            ...
            {"url": "http://example.com/2", "error_type": "HTTPError", "status_code": 404},
            {"url": "http://example.com/3", "error_type": "ConnectionError"},
            {"url": "http://example.com/4", "error_type": "HTTPError", "status_code": 500},
        ]
