...
class TestFormatSelectionIntegration:
    ...
    def test_format_manager_field_selection_override(self):
        ...
        with patch.dict('sys.modules', {
            ...
            from src.file_generator.file_generator_service import FileGenerationRequest, FileGeneratorService
            ...
            with patch.object(service, '_generate_json_file') as mock_json_gen:
                ...
                with patch.object(service, '_generate_with_format_manager') as mock_format_gen:
    ...
    def test_generate_with_format_manager_method_exists(self):
        ...
        with patch.dict('sys.modules', {
            ...
            with patch.object(service, '_generate_json_file') as mock_json_gen:
                ...
                enhanced_request = call_args[0][0]  # First argument is the enhanced request
