...
class TestEnhancedJSONLDExtractor:
    ...
    def test_extractor_with_extraction_context(self):
        ...
        from src.scraper.enhanced_json_ld_extractor import JSONLDExtractor, ExtractionContext
    ...
    def test_extraction_with_pattern_cache(self):
        ...
        from src.scraper.enhanced_json_ld_extractor import JSONLDExtractor, ExtractionContext, PatternCache
        ...
        assert len(results) == 1
        assert pattern_cache.get_pattern_stats()["json_ld_path"]["Restaurant/@type"]["uses"] > 0
    ...
    def test_extraction_confidence_with_context(self):
        ...
        assert results[0].extraction_metadata.get('confidence_boost') == 'sibling_pattern_match'
    ...
    def test_extraction_history_tracking(self):
        ...
        from src.scraper.enhanced_json_ld_extractor import JSONLDExtractor, ExtractionContext, ExtractionHistory
        
        history = ExtractionHistory()
        history.add_extraction("rest_001", "json-ld", {"name": "Old Name"}, "2024-01-01T10:00:00")
    ...
    def test_cross_page_reference_detection(self):
        ...
        assert '/restaurants/italian-bistro/menu' in results[0].extraction_metadata['referenced_pages']

    def test_aggregated_extraction_by_entity(self):
        """Test aggregating multiple extractions for the same entity."""
        from src.scraper.enhanced_json_ld_extractor import JSONLDExtractor, ExtractionAggregator
    ...
    def test_extraction_coverage_metrics(self):
        ...
        tracker.record_extraction('rest_001', 'json-ld', success=True, confidence='high')
        tracker.record_extraction('rest_002', 'json-ld', success=True, confidence='high')
        tracker.record_extraction('rest_003', 'heuristic', success=True, confidence='medium')
