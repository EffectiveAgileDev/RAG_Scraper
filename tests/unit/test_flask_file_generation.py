...
class TestFlaskFileGeneration:
    ...
    def test_generate_file_endpoint_invalid_format(self, client, sample_restaurant_data):
    ...
    def test_generate_file_with_preferences_saving(self, client, sample_restaurant_data):
...
class TestFileGenerationIntegration:
    ...
    def test_full_workflow_generate_and_download(self, client):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            # Generate file
            generate_response = client.post('/api/generate-file',
                json={
    ...
    def test_configuration_persistence_across_requests(self, client):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            update_response = client.post('/api/file-config',
                json={
                    'output_directory': custom_dir,
                    'allow_overwrite': False
                },
