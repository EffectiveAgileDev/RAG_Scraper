...
class TestAdvancedProgressMonitorMultiPage(unittest.TestCase):
    ...
    def test_enable_multipage_monitoring_sets_session_flag(self):
        ...
        session_id = self.monitor.start_monitoring_session(
        ...
        self.assertTrue(
            session.get("multipage_enabled", False),
    ...
    def test_enable_multipage_monitoring_initializes_page_progress(self):
        ...
        session = self.monitor.sessions[session_id]
        self.assertIn(
            "page_progress", session, "Session should contain page progress data"
        )
        ...
        self.assertIsInstance(
            page_progress["page_urls"], list, "Should initialize page URLs list"
        )
        self.assertIsInstance(
            page_progress["completed_pages"],
            list,
            "Should initialize completed pages list",
        )
        self.assertIsInstance(
            page_progress["failed_pages"], list, "Should initialize failed pages list"
        )
    ...
    def test_get_page_progress_returns_correct_total_pages_when_multipage_enabled(self):
        ...
        self.assertEqual(
            page_progress.total_pages, 4, "Multi-page site should report 4 total pages"
        )
        self.assertEqual(page_progress.current_page, 1, "Should start at page 1")
    ...
    def test_get_page_progress_returns_one_page_when_multipage_disabled(self):
        ...
        session_id = self.monitor.start_monitoring_session(
            ["https://single-page-restaurant.com"]
        )
        ...
        self.assertEqual(
            page_progress.total_pages, 1, "Single-page site should report 1 total page"
        )
        self.assertEqual(page_progress.current_page, 1, "Should start at page 1")
    ...
    def test_update_page_progress_updates_current_page_number(self):
        ...
        self.monitor.update_page_progress(
            "https://multi-page-restaurant.com/menu", 2, 4
        )
        ...
        self.assertEqual(
            page_progress.current_url,
            "https://multi-page-restaurant.com/menu",
    ...
    def test_page_notifications_generated_on_page_start(self):
        ...
        start_notifications = [
            n for n in notifications if "Starting page" in n["message"]
        ]
        self.assertGreater(
            len(start_notifications), 0, "Should have page start notifications"
        )
    ...
    def test_page_completion_events_generated(self):
        ...
        # Act: Complete page 1
        self.monitor.add_completion_event(
            "page_completed",
            "https://multi-page-restaurant.com",
        ...
        self.assertGreater(
            len(page_completions), 0, "Should have page completion events"
        )
    ...
    def test_session_persistence_across_multipage_operations(self):
        ...
        self.monitor.update_page_progress(
            "https://multi-page-restaurant.com/about", 3, 4
        )

        # Assert: Session should remain consistent
        self.assertEqual(
            self.monitor.active_session_id,
            original_session_id,
        ...
        self.assertIn(
            "page_progress", session, "Page progress data should remain in session"
        )
        ...
        self.assertEqual(
            page_progress.current_page, 3, "Should reflect latest page update"
        )
