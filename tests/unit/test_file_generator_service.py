...
class TestFileGeneratorService:
    ...
    def test_generate_text_file_with_default_config(self, file_service, sample_restaurants, temp_config_dir):
    ...
    def test_generate_text_file_with_custom_directory(self, file_service, sample_restaurants, temp_config_dir):
    ...
    def test_directory_permission_validation_success(self, file_service, sample_restaurants, temp_config_dir):
    ...
    def test_directory_permission_validation_failure(self, file_service, sample_restaurants):
    ...
    def test_directory_creation_when_needed(self, file_service, sample_restaurants, temp_config_dir):
    ...
    def test_persistent_directory_configuration(self, file_service, sample_restaurants, temp_config_dir):
    ...
    def test_file_overwrite_handling(self, file_service, sample_restaurants, temp_config_dir):
    ...
    def test_file_overwrite_protection(self, file_service, sample_restaurants, temp_config_dir):
    ...
    def test_invalid_file_format_handling(self, file_service, sample_restaurants, temp_config_dir):
...
class TestFileServiceIntegration:
    ...
    def test_full_workflow_with_persistence(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            restaurants = [
                RestaurantData(name="Restaurant 1", phone="555-0001", sources=["heuristic"]),
                RestaurantData(name="Restaurant 2", phone="555-0002", sources=["heuristic"])
            ]
