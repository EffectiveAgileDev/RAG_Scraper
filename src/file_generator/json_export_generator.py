...
class JSONExportGenerator:
    ...
    def _format_additional_details(self, restaurant_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _format_characteristics(self, restaurant_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def generate_json_file(self, restaurant_list: List[Dict[str, Any]], 
                          output_path: str, 
                          field_selection: Optional[Dict[str, bool]] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if not self.validate_field_selection(active_field_selection):
                return self._create_error_result("Invalid field selection configuration")
            ...
            json_data = self._create_json_structure(restaurant_list, formatted_restaurants)
    ...
    def _validate_inputs(self, restaurant_list: List[Dict[str, Any]], output_path: str) -> bool:
        """Validate input parameters."""
        return (
            isinstance(restaurant_list, list) and
            isinstance(output_path, str) and
            len(output_path.strip()) > 0
        )
    ...
    def _process_restaurant_list(self, restaurant_list: List[Dict[str, Any]], 
                                field_selection: Dict[str, bool]) -> List[Dict[str, Any]]:
    ...
    def _create_json_structure(self, restaurant_list: List[Dict[str, Any]], 
                              formatted_restaurants: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _create_success_result(self, file_path: str, restaurant_count: int) -> Dict[str, Any]:
    ...
    def _apply_field_selection(self, formatted_data: Dict[str, Any], 
                              field_selection: Dict[str, bool]) -> Dict[str, Any]:
        """
    ...
    def _get_null_value_for_field(self, field_name: str) -> Union[None, List]:
        ...
        list_fields = {
            'cuisine_types', 'special_features', 'menu_items',
            'social_media', 'delivery_options', 'dietary_accommodations'
        }
