...
class PageClassifier:
    ...
    URL_PATTERNS = {
        'menu': [
            r'/menu/?$', r'/food/?$', r'/dining/?$', r'/eat/?$',
            r'/menus/?$', r'/drinks/?$', r'/beverages/?$'
        ],
        'contact': [
            r'/contact/?$', r'/contacts/?$', r'/reach/?$', r'/touch/?$',
            r'/info/?$', r'/information/?$', r'/location/?$', r'/locations/?$'
        ],
        'about': [
            r'/about/?$', r'/story/?$', r'/history/?$', r'/our[-_]story/?$',
            r'/who[-_]we[-_]are/?$', r'/background/?$', r'/bio/?$'
        ],
        'hours': [
            r'/hours/?$', r'/time/?$', r'/times/?$', r'/schedule/?$',
            r'/when/?$', r'/open/?$', r'/operating/?$'
        ],
        'home': [
            r'/?$', r'/index/?$', r'/home/?$', r'/main/?$'
        ]
    }
    ...
    CONTENT_INDICATORS = {
        'menu': {
            'headings': ['menu', 'food', 'drinks', 'appetizers', 'entrees', 'desserts', 'beverages'],
            'classes': ['menu', 'food-menu', 'restaurant-menu', 'menu-section', 'menu-item'],
            'keywords': ['price', '$', 'appetizer', 'entree', 'dessert', 'beverage', 'wine', 'beer']
        },
        'contact': {
            'headings': ['contact', 'reach us', 'get in touch', 'find us', 'location', 'address'],
            'classes': ['contact', 'contact-info', 'address', 'phone', 'location'],
            'keywords': ['phone', 'address', 'email', 'hours', 'directions', 'map', 'location']
        },
        'about': {
            'headings': ['about', 'our story', 'history', 'who we are', 'background'],
            'classes': ['about', 'story', 'history', 'bio', 'background'],
            'keywords': ['story', 'history', 'founded', 'family', 'tradition', 'chef', 'owner']
        },
        'hours': {
    ...
    def is_restaurant_related(self, html_content: str) -> bool:
        ...
        restaurant_keywords = [
            'restaurant', 'dining', 'cuisine', 'chef', 'food', 'menu',
            'eat', 'drink', 'bar', 'grill', 'cafe', 'bistro', 'eatery',
            'kitchen', 'culinary', 'taste', 'flavor', 'dish', 'meal'
        ]
