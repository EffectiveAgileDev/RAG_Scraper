...
class MicrodataExtractionResult:
    ...
    def __init__(self, name: str = "", address: str = "", phone: str = "",
                 ...
                 confidence: str = "medium", source: str = "microdata"):
        self.name = name
...
class MicrodataExtractor:
    ...
    def _extract_address(self, element) -> str:
        ...
        for addr_elem in address_elements:
            ...
            if addr_elem.get('itemtype') and 'postaladdress' in addr_elem.get('itemtype', '').lower():
        ...
        for menu_elem in menu_elements:
            ...
            for section_elem in section_elements:
                ...
                if section_name_elem:
                    section_name = section_name_elem.get_text(strip=True) or "Menu Items"
    ...
    def _calculate_confidence(self, data: Dict[str, Any]) -> str:
        ...
        important_fields = ['address', 'phone', 'hours', 'price_range', 'cuisine', 'menu_items']
