...
class MultiPageScraper:
    ...
    def process_discovered_pages(
        ...
        restaurant_name = self.data_aggregator.page_data[0].restaurant_name if self.data_aggregator.page_data else "Restaurant"
            ...
            try:
                ...
                if page_result:
                    ...
                    page_data = PageData(
                        ...
                        source=page_result['data'].sources[0] if page_result['data'].sources else 'unknown',
    ...
    def _fetch_page(self, url: str) -> Optional[str]:
        ...
        """
        try:
            if self.enable_ethical_scraping and self.multi_strategy_scraper.ethical_scraper:
                # Use ethical scraper with rate limiting
                html_content = self.multi_strategy_scraper.ethical_scraper.fetch_page_with_retry(url)
                return html_content
            else:
