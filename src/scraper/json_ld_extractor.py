...
class JSONLDExtractionResult:
    ...
    def __init__(self, name: str = "", address: str = "", phone: str = "",
                 ...
                 confidence: str = "medium", source: str = "json-ld"):
        self.name = name
...
class JSONLDExtractor:
    ...
    def extract_restaurant_data(self, json_data: Any) -> Optional[JSONLDExtractionResult]:
    ...
    def is_relevant_schema_type(self, schema_type: str) -> bool:
        ...
        if isinstance(schema_type, list):
            return any(t.lower() in {'restaurant', 'foodestablishment', 'localbusiness'} 
                      for t in schema_type)
        return schema_type.lower() in {'restaurant', 'foodestablishment', 'localbusiness'}
    ...
    def _calculate_confidence(self, json_data: Dict[str, Any]) -> str:
        ...
        important_fields = ['address', 'telephone', 'openingHours', 'priceRange', 'servesCuisine', 'hasMenu']
