...
class RestWSchemaSelector:
    ...
    def __init__(self, selected: bool = False, industry: str = None, 
                 css_class: str = "", disabled: bool = False):
...
class RestWFieldSelector:
    ...
    def get_field_description(self, field_name: str) -> str:
        ...
        return descriptions.get(field_name, f'Extract {field_name.replace("_", " ")} data')
...
class RestaurantSchemaTypeSelector:
    ...
    def __init__(self, selected_schema_type: str = "Restaurant", css_class: str = "schema-type-selector", 
                 disabled: bool = False, show_help_text: bool = True):
    ...
    def render(self) -> str:
        ...
        if self.show_help_text:
            html += '<div id="schema-type-help-selector" class="schema-type-help"></div>\n'
...
class RestaurantSchemaTypeHelpText:
    ...
    def __init__(self, schema_type: str = "Restaurant", show_icon: bool = True, 
                 collapsible: bool = True, css_class: str = "schema-type-help"):
    ...
    def get_help_content(self) -> str:
        ...
        if self.schema_type == "Restaurant":
            ...
            return "<p>Schema type not supported. Please select a valid schema type.</p>"
...
class RestaurantSchemaTypeDropdown:
    ...
    def __init__(self, selected_schema_type: str = "Restaurant", css_class: str = "schema-type-dropdown", 
                 disabled: bool = False, required: bool = True, show_help_text: bool = True):
    ...
    def render(self) -> str:
        ...
        if not self.required:
            html += f'        <option value="" disabled>Select schema type...</option>\n'
